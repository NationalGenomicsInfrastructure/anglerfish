    ...
    def _run_explore(
        ...
        for adaptor, aln_path in adaptors_and_aln_paths:
            ...
            if min(nr_good_hits.values()) >= min_hits_per_adaptor:
                ...
                results["included_adapters"][adaptor.name] = adaptor_data
                adaptors_included.append(adaptor)
            else:
                results["excluded_adapters"][adaptor.name] = adaptor_data
...
def check_for_umis(
    ...
    for adaptor in adaptors_included:
        adaptor_data = results["included_adapters"][adaptor.name]
